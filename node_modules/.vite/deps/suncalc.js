...
//#endregion
//#region node_modules/suncalc/suncalc.js
var require_suncalc = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function() {
		"use strict";
		...
		SunCalc.getTimes = function(date, lat, lng, height) {
			height = height || 0;
			var lw = rad * -lng, phi = rad * lat, dh = observerAngle(height), n = julianCycle(toDays(date), lw), ds = approxTransit(0, lw, n), M = solarMeanAnomaly(ds), L = eclipticLongitude(M), dec = declination(L, 0), Jnoon = solarTransitJ(ds, M, L), i, len, time, h0, Jset, Jrise;
			var result = {
